...
public class SystemController extends BaseController {
    ...
    public String hello() {
        List<Notice> notices = noticeService.getNoticeListByNotgetPagination();
    ...
    public String message() {
        List<Notice> list = noticeService.getNoticeListByNotgetPagination();
        // 获取未读通知的数量
        int count = noticeService.getUnReadNum(list);
        // 修改阅读通知的状态
        noticeService.modifyNoticeStatus(list);
        super.setAttr("messageList", list);
        super.setAttr("messageNum", list.size());
        super.setAttr("unReadNum", count);
